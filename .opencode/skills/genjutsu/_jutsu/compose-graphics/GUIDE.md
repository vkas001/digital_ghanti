...
> Foundation: `../compose-motion/GUIDE.md` covers basics. Concise rules here. Deep-dive in `references/`.
...
| Base animations (animateAsState, AnimatedVisibility, Transition) | `../compose-motion/GUIDE.md` |
| CMP patterns (shared UI iOS / Android / Desktop) | `../compose-multiplatform/GUIDE.md` |
