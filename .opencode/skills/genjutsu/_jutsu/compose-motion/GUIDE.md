...
See `../motion-principles/GUIDE.md` for the cross-platform doctrine.
...
| Advanced (M3 Expressive, AGSL, Canvas) | `../compose-graphics/GUIDE.md` |
| CMP / KMP patterns | `../compose-multiplatform/GUIDE.md` |
