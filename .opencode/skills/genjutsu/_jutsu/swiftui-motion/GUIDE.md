...
> Pair with `../motion-principles/GUIDE.md` (foundation) and `../mobile-principles/GUIDE.md` (touch UX).
...
Mandatory. SwiftUI exposes the iOS / macOS "Reduce Motion" accessibility setting via the environment. See `../motion-principles/GUIDE.md` for the cross-platform rationale.
...
| Advanced visuals (Metal, Liquid Glass) | `../swiftui-graphics/GUIDE.md` |
| Cross-platform UX (mobile, desktop) | `../mobile-principles/GUIDE.md`, `../desktop-principles/GUIDE.md` |
| Foundation (timing, easing, a11y) | `../motion-principles/GUIDE.md` |
