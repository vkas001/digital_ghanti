...
| GSAP specifics | `../gsap/GUIDE.md` |
| Framer Motion specifics | `../framer-motion/GUIDE.md` |
| CSS-only animations | `../css-native/GUIDE.md` |
| Three.js / R3F | `../threejs-r3f/GUIDE.md` |
| Canvas / generative | `../canvas-generative/GUIDE.md` |
| Compose Android animations | `../compose-motion/GUIDE.md` |
| Compose Multiplatform | `../compose-multiplatform/GUIDE.md` |
| SwiftUI iOS/macOS animations | `../swiftui-motion/GUIDE.md` |
| Compose advanced graphics | `../compose-graphics/GUIDE.md` |
| SwiftUI advanced graphics | `../swiftui-graphics/GUIDE.md` |
| Visual / motion / a11y audit | `../design-audit/GUIDE.md` |
| UI/UX intelligence (84 styles, 192 palettes) | `../ui-ux-pro-max/GUIDE.md` |
